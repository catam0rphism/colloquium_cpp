#include <fstream>
#include "../struct.h"
natural SUB_NN_N(const natural, const natural); //user function
...
#include "../Модули/SUB_NN_N.cpp" //user function
#include "../Модули/COM_NN_D.cpp" //для user function
...
{
	unsigned short n;
	fstream file("../Тесты/SUB_NN_N",ios::in);
