...
using namespace std;
#include "../struct.h"
natural LCM_NN_N(const natural, const natural); //user function
natural GCF_NN_N(const natural, const natural); //для user function
natural MOD_NN_N(const natural,const natural); //для GCF_NN_N
...
# include "../modules/LCM_NN_N.cpp" //user function
#include "../modules/GCF_NN_N.cpp" //для user function
#include "../modules/MOD_NN_N.cpp" //для GCF_NN_N
...
int main()
{
	unsigned short n=1;
	char comment[256];
	fstream file("../tests/LCM_NN_N",ios::in);
