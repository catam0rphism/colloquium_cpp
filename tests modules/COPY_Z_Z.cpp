...
using namespace std;
#include "../struct.h"
integer COPY_Z_Z(const integer); //user function
...
#include "../modules/COPY_Z_Z.cpp" //user function
...
int main()
{
	unsigned short n=1;
	char comment[256];
	fstream file("../tests/COPY_Z_Z",ios::in);
