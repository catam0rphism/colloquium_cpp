...
#include "LCM_NN_N.cpp"   // НОК
#include "MUL_ZZ_Z.cpp"   // Умножение
#include "SUB_ZZ_Z.cpp"	  // Вычитание
#include "DIV_NN_N.cpp"   // Деление
#include "TRANS_N_Z.cpp"  // Натуральное->целое
#include "RED_Q_Q.cpp"    // Сокращение

fractional SUB_QQ_Q(fraction &fract_1, fraction &fract_2)
{
